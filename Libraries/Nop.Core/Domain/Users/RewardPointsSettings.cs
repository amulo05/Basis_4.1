...
namespace Nop.Core.Domain.Users
{
    ...
    public class RewardPointsSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a number of points awarded for purchases (amount in primary site currency)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether all reward points are accumulated in one balance for all sites and they can be used in any site. Otherwise, each site has its own rewards points and they can only be used in that site.
        /// </summary>
        public bool PointsAccumulatedForAllSites { get; set; }
