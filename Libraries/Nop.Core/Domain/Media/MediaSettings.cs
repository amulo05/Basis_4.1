...
namespace Nop.Core.Domain.Media
{
    ...
    public class MediaSettings : ISettings
    {
        ...
        ///private               — allows caches that are specific to one user (e.g., in a browser) to site the response; shared caches (e.g., in a proxy) may not.
        ///no-cache              — forces caches to submit the request to the origin server for validation before releasing a cached copy, every time. This is useful to assure that authentication is respected (in combination with public), or to maintain rigid freshness, without sacrificing all of the benefits of caching.
        ///no-site              — instructs caches not to keep a copy of the representation under any conditions.
