...
namespace Nop.Services.Logging
{
    ...
    public class UserActivityService : IUserActivityService
    {
        ...
        {
            if (activityLogTypeId == default(Guid))
                return null;
        ...
        public virtual IPagedList<ActivityLog> GetAllActivities(DateTime? createdOnFrom = null, DateTime? createdOnTo = null, 
            Guid? userId = null, Guid? activityLogTypeId = null, string ipAddress = null, string entityName = null, Guid? entityId = null,
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            //filter by user
            if (userId.HasValue && userId.Value != default(Guid))
